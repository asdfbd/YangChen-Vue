package com.yangchen.framework.web.exception;
...
import com.yangchen.common.exception.DemoModeException;
import com.yangchen.common.exception.ServiceException;
import com.yangchen.common.utils.html.EscapeUtil;
...
public class GlobalExceptionHandler {
    ...
    public R handleServiceException(ServiceException e, HttpServletRequest request) {
        ...
        return ObjectUtil.isNotNull(code) ? R.error(code, e.getMessage()) : R.error(e.getMessage());
    }
    ...
    public R handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e, HttpServletRequest request) {
        ...
        return R.error(String.format("请求参数类型不匹配，参数[%s]要求类型为：'%s'，但输入值为：'%s'", e.getName(), e.getRequiredType().getName(), value));
    }
