package com.yangchen.framework.interceptor.impl;
...
import com.yangchen.common.filter.RepeatedlyRequestWrapper;
import com.yangchen.common.utils.JsonUtils;
import com.yangchen.framework.interceptor.RepeatSubmitInterceptor;
...
public class SameUrlDataInterceptor extends RepeatSubmitInterceptor {
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation) {
        ...
        if (request instanceof RepeatedlyRequestWrapper) {
            ...
            nowParams = JakartaServletUtil.getBody(repeatedlyRequest);
        }
