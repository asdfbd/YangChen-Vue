...
public class FileUtils {
    ...
    public static String writeImportBytes(byte[] data) throws IOException {
        return writeBytes(data, YangChenConfig.getImportPath());
    }
    ...
    public static boolean checkAllowDownload(String resource) {
        ...
        // 检查允许下载的文件规则
        if (ArrayUtils.contains(MimeTypeUtils.DEFAULT_ALLOWED_EXTENSION, FileNameUtil.extName(resource))) {
            return true;
        }
    ...
    /**
     * 获取文件名称 /profile/upload/2022/04/16/yangchen.png -- yangchen.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2022/04/16/yangchen.png -- yangchen
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
