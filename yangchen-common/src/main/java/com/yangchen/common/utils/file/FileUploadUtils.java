package com.yangchen.common.utils.file;

import cn.hutool.core.util.IdUtil;
import cn.hutool.core.util.StrUtil;
import com.yangchen.common.config.YangChenConfig;
import com.yangchen.common.constant.Constants;
import com.yangchen.common.exception.file.FileNameLengthLimitExceededException;
import com.yangchen.common.exception.file.FileSizeLimitExceededException;
import com.yangchen.common.exception.file.InvalidExtensionException;
import com.yangchen.common.utils.DateUtils;
import com.yangchen.common.utils.uuid.Seq;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = YangChenConfig.getProfile();
    ...
    public static final String extractFilename(MultipartFile file) {
        return StrUtil.format("{}/{}_{}.{}", DateUtils.datePath(), FilenameUtils.getBaseName(file.getOriginalFilename()), Seq.getId(Seq.uploadSeqType), getExtension(file));
    }
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = YangChenConfig.getProfile().length() + 1;
