package com.yangchen.common.utils.poi;

import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import com.yangchen.common.annotation.Excel;
import com.yangchen.common.annotation.Excel.ColumnType;
import com.yangchen.common.annotation.Excel.Type;
...
import com.yangchen.common.exception.UtilException;
...
import com.yangchen.common.utils.file.ImageUtils;
import com.yangchen.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
            ...
            for (int i = titleNum + 1; i <= rows; i++) {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet()) {
                    ...
                    if (ObjectUtil.isNotNull(fieldType)) {
                        ...
                        if (StrUtil.isNotEmpty(attr.readConverterExp())) {
                        ...
                        } else if (ColumnType.IMAGE == attr.cellType() && cn.hutool.core.map.MapUtil.isNotEmpty(pictures)) {
                            StringBuilder propertyString = new StringBuilder();
                            ...
                            val = org.apache.commons.lang3.StringUtils.stripEnd(propertyString.toString(), SEPARATOR);
                        }
    ...
    public void setDataValidation(Excel attr, Row row, int column) {
        ...
        if (StrUtil.isNotEmpty(attr.prompt()) || attr.combo().length > 0 || attr.comboReadDict()) {
            ...
            if (attr.comboReadDict()) {
                ...
                comboArray = StrUtil.split(val, DictUtils.SEPARATOR).toArray(new String[0]);
            }
            if (comboArray.length > 15 || StrUtil.join(",", comboArray).length() > 255) {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = YangChenConfig.getDownloadPath() + filename;
    ...
    public List<Object[]> getFields() {
        ...
        if (cn.hutool.core.util.ArrayUtil.isNotEmpty(includeFields)) {
            for (Field field : tempFields) {
                if (ArrayUtils.contains(this.includeFields, field.getName()) || field.isAnnotationPresent(Excels.class)) {
                    addField(fields, field);
                }
            }
        } else if (cn.hutool.core.util.ArrayUtil.isNotEmpty(excludeFields)) {
            for (Field field : tempFields) {
    ...
    public boolean isSubList() {
        return !cn.hutool.core.map.MapUtil.isEmpty(subFieldsMap);
    }
    ...
    public boolean isSubListValue(T vo) {
        return !cn.hutool.core.map.MapUtil.isEmpty(subFieldsMap) && getListCellValue(vo) > 0;
    }
