...
public class SysUserController extends BaseController {
    ...
    public R getInfo(@PathVariable(value = "userId", required = false) @Parameter(description = "用户ID") Long userId) {
        R ajax = R.ok();
    ...
    public R remove(@PathVariable @Parameter(description = "用户ID") Long[] userIds) {
    ...
    public R authRole(@PathVariable("userId") @Parameter(description = "用户ID") Long userId) {
        R ajax = R.ok();
