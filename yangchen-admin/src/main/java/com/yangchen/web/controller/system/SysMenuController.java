...
public class SysMenuController extends BaseController {
    ...
    public R getInfo(@PathVariable @Parameter(description = "菜单ID") Long menuId) {
    ...
    public R roleMenuTreeselect(@PathVariable("roleId") @Parameter(description = "角色ID") Long roleId) {
    ...
    public R remove(@PathVariable("menuId") @Parameter(description = "菜单ID") Long menuId) {
