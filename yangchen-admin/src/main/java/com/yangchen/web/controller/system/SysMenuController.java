...
public class SysMenuController extends BaseController {
    ...
    public AjaxResult getInfo(@PathVariable @Parameter(description = "菜单ID") Long menuId) {
    ...
    public AjaxResult roleMenuTreeselect(@PathVariable("roleId") @Parameter(description = "角色ID") Long roleId) {
    ...
    public AjaxResult add(@Validated @RequestBody SysMenu menu) {
        ...
        } else if (UserConstants.YES_FRAME.equals(menu.getIsFrame()) && !StrUtil.startWithAnyIgnoreCase(menu.getPath(), "http://", "https://")) {
    ...
    public AjaxResult remove(@PathVariable("menuId") @Parameter(description = "菜单ID") Long menuId) {
