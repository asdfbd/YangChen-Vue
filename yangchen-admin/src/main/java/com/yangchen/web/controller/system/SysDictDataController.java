...
public class SysDictDataController extends BaseController {
    ...
    public AjaxResult getInfo(@PathVariable @Parameter(description = "字典编码") Long dictCode) {
    ...
    public AjaxResult dictType(@PathVariable @Parameter(description = "字典类型") String dictType) {
    ...
    public AjaxResult remove(@PathVariable @Parameter(description = "字典编码") Long[] dictCodes) {
