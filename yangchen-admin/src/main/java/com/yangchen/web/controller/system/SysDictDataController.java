...
public class SysDictDataController extends BaseController {
    ...
    public R getInfo(@PathVariable @Parameter(description = "字典编码") Long dictCode) {
    ...
    public R dictType(@PathVariable @Parameter(description = "字典类型") String dictType) {
    ...
    public R remove(@PathVariable @Parameter(description = "字典编码") Long[] dictCodes) {
